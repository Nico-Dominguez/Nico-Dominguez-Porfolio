...
const Projects = () => {
  return (
    <div
      className="bg-gradient-to-tl from-blue-700 to-blue-500 p-6 shadow-lg grid gap-4 rounded"
      id="projects"
    >
      <h1 className="font-serif italic text-3xl font-bold">Work Experience</h1>
      <div className="flex flex-col lg:flex-row gap-4">
        <Link
          to="/project/grn-palmetto"
          className="p-6 grid gap-4 text-blue-900 transition ease-in bg-blue-50 hover:bg-blue-800 duration-300 hover:text-blue-50 rounded "
        >
